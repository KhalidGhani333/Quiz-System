...
let questions =  await inquirer.prompt([
    ...
    },
    {
        ...
        choices:[
            ...
            "D. let variable: string | null;"]   //correct
    },
    {
        name:"q5",
        type:"list",
    ...
    },
    {
        ...
        choices:[
            ...
            "D. By using type annotations"]  //correct
    }
])
...
switch (questions.q6) {case "B. Store a set of named constants,numeric or string":
        console.log(chalk.green("Correct"))
        ++result;
        break;
      default:
...
console.log(
    chalk.italic.blue(
      `\n\t <<<<---- ${chalk.bold.yellowBright(
        questions.Name
      )}: Score ${chalk.bold.yellowBright(result)} out of ${chalk.bold.yellowBright(
        10
      )} ---->>>> 👍`
    )
  );
